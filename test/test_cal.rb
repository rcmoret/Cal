...
class CalTest < Test::Unit::TestCase
  ...
  def test_6_print_last_lines_of_days
    cal = IndividualMonth.new(2012, 2)
  ...
  def test_7_the_entire_array_for_a_month
    # To print just call .join(/n) on this array
    cal = IndividualMonth.new(2012, 2)
    expected = []
